//Declaring variables that correspond with each of my paragraph elements p1, p2, p3, p4, and intro
...
function scene3() {
    //clears the screen of the other stuff and makes the font smaller
    img2.style.display = "none"
    p1.textContent = ""
    ...
    //hides the other buttons so you only see what you need
...
function scene4() {
    //clears the screen of the other stuff
    img2.style.display = "none"
    p1.textContent = ""
    //change the text content
    ...
    //removes all the option event listeners so that you stay locked into the gauntlets choice
    option1.removeEventListener("click", scene3)
    option2.removeEventListener("click", scene4)
    option3.removeEventListener("click", scene5)
    option4.removeEventListener("click", scene6)
...
function scene5() {
    ...
    img3.src = "fan.jpg"
    img3.style.display = "block"
    //changes the text color and the background color
    p2.style.color = "lightgreen"
    document.body.style.backgroundColor = "Steelblue"
    //removes all the option event listeners so that you stay locked into the fan choice
    option1.removeEventListener("click", scene3)
    option2.removeEventListener("click", scene4)
    option3.removeEventListener("click", scene5)
    option4.removeEventListener("click", scene6)
...
function scene6() {
    ...
    //removes all the option event listeners so that you stay locked into the decanter choice
    option1.removeEventListener("click", scene3)
    option2.removeEventListener("click", scene4)
    option3.removeEventListener("click", scene5)
    option4.removeEventListener("click", scene6)
...
function scene7() {
    ...
    //removes all the option event listeners
...
function scene9() {
    ...
    option1.textContent = "Let them live"
    option2.textContent = "Kill them all"
}
...
function scene12(){
    ...
    //secret easter egg for loop event listener
    secret.addEventListener("click", function secrety() {
        //hide the secret button and the image
        secret.style.visibility = "hidden"
        img5.style.display = "none"
        //for loop that easter egg
        for (let i = 0; i < 1; i++){
            p4.textContent = "Yo you found a secret easter egg. This doesn't do anything I just needed a for loop."
